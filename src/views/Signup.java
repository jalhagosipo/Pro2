...
public class Signup extends JFrame {
	...
	public Signup() {
		...
		JLabel label_title = new JLabel("»∏ø¯∞°¿‘");
		label_title.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.BOLD, 20));
		label_title.setBounds(145, 39, 80, 27);
		panel.add(label_title);
		
		JLabel label_id = new JLabel("ID");
		label_id.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 15));
		label_id.setBounds(45, 150, 50, 15);
		panel.add(label_id);
		
		JLabel label_pwd = new JLabel("∫Òπ–π¯»£");
		label_pwd.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 15));
		label_pwd.setBounds(45, 200, 60, 15);
		panel.add(label_pwd);
		
		JLabel label_repwd = new JLabel("∫Òπ–π¯»£ »Æ¿Œ");
		label_repwd.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 15));
		label_repwd.setBounds(45, 250, 97, 15);
		panel.add(label_repwd);
		
		JLabel label_name = new JLabel("¿Ã∏ß");
		label_name.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 15));
		label_name.setBounds(45, 100, 50, 15);
		panel.add(label_name);
		
		JLabel label_phone = new JLabel("»ﬁ¥Î¿¸»≠");
		label_phone.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 15));
